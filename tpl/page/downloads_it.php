...
<div class="module">
  ...
  <ul class="links">
    ...
    <li><a href="http://mgeisler.net/php-shell/" target="_blank">PHP Shell [link]</a><p>a shell wrapped in a PHP script</p></li>
    <li><a href="http://www.sf-soft.de/winhex/index-m.html" target="_blank">WinHEX [link]</a><p>a universal hexadecimal editor</p></li>
    <li><a href="http://www.ollydbg.de/" target="_blank">Ollydbg [link]</a><p>a 32-bit assembler level analysing debugger for Windows</p></li>
    <li><a href="http://members.fortunecity.com/neshkov/dj.html" target="_blank">DJ Java Decompiler [link]</a><p>allows you to decompile java CLASS files and save it in text or other formats</p></li>
  </ul>
  </div>
  <h3>Misc</h3>
  <div class="content">
